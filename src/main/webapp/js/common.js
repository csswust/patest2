	...
	var program = {
		...
		leftMenu : function() {
			var htmlLeft = '<ul class="sidebar-menu  nav-stacked nav">'
					...
					+ '</li>'
					/*+ '<li class="tree">'
					+ '<a href="javascript:;" class="treeview courseMana"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>  <span>课程管理</span></a>'
					+ '<ul class="treeview-menu">'
					+ '<li><a href="knowLeage.html" class="knowLeage">知识点管理</a></li>'
					+ '</ul>'
					+ '</li>'*/
/*					+ '<li>'
					+ '<a href="javascript:;" class="treeview examRoom"><span class="glyphicon glyphicon-credit-card" aria-hidden="true"></span>  <span>考场管理</span></a>'
					+ '<ul class="treeview-menu">'
					+ '<li><a href="examList.html" class="examination">考试列表</a></li>'
					+ '</ul>'
					+ '</li>'*/
					+ '<li>'
					...
					+ '</li>'
/*					+ '<li>'
					+ '<a href="javascript:;" class="treeview billMana"><span class="glyphicon glyphicon-align-justify" aria-hidden="true"></span> <span>账单管理</span></a>'
					+ '<ul class="treeview-menu">'
					+ '<li><a href="adminbill.html" class="billset">账单列表</a></li>'
					+ '</ul>'
					+ '</li>'*/
					+ '<li>'
